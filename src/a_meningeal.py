...
adata = sc.read_h5ad("/home/makowlg/Documents/Immune-CCI/h5ad_files/adata_final_Meningeal_Vascular_raw_norm_ranked_copy.h5ad") # enter h5ad file name 
#print(adata)

# # Clusters
# # New directory 
# reso_meninge = "reso_meninge"

# # Delete the existing dir if exists
# if os.path.exists(reso_meninge):
#     shutil.rmtree(reso_meninge)

# os.makedirs(reso_meninge)

# # Creates the dir
# if not os.path.exists(reso_meninge):
#   os.makedirs(reso_meninge)
...
#     output_path = os.path.join(reso_meninge, f"UMAP_{resolution}.png")
    
#     # Save the figure in the specified directory
#     ax.savefig(output_path, bbox_inches="tight")
